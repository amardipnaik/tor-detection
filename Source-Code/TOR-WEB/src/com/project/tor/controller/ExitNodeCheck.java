...
public class ExitNodeCheck {
    ...
    public static void main(String args[])
    {
    	...
    	System.out.println("I@@@@@@@@@@@@@@ In ExitNodeCheck @@@@@@@@@@@@@@@");
    	//ExitNodeCheck exitNodeCheck=new ExitNodeCheck();
    	boolean result=ExitNodeCheck.isExitNodeInTorDnsExitList("41.231.53.101", "52.91.254.30", 55200);
    	boolean isTorExitNode2 = ExitNodeCheck.isExitNodeInOnlineList("162.247.72.201");
    	System.out.println(" Is This a TOR Exit Node :: "+result);
